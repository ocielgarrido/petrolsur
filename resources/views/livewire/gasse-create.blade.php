<div id="form-create">
    <x-jet-form-section :submit="$action" class="mb-4">
        ...
        <x-slot name="form"> 
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="pm10" value="{{ __('PM10:') }}" />
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="pm316" value="{{ __('PM316:') }}" />
                <x-jet-input id="number" type="number" step="1"  class="mt-1 block w-full form-control shadow-none" wire:model.defer="gasse.pm316"  />
                <x-jet-input-error for="gasse.pm316" class="mt-2" />        
            </div>  
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="a9300" value="{{ __('A 9300:') }}" />
                <x-jet-input id="a9300" type="number" step="1" class="mt-1 block w-full form-control shadow-none" wire:model.defer="gasse.a9300"  />
                <x-jet-input-error for="gasse.a9300" class="mt-2" />        
            </div>  
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="obs" value="{{ __('Observaciones:') }}" />
                <x-textarea  id="obs" rows="3" cols="30" wire:model.defer="gasse.obs" style="width: 100%"/>
                <x-jet-input-error for="gasse.obs" class="mt-2" />        
            </div>  
...
<script>
    document.addEventListener('DOMContentLoaded', function(){
        flatpickr(document.getElementsByClassName('flatpickr'),{
          ...
          locale: "es",
          minDate: "{!! $primerDia !!}",
          maxDate: "{!! $gasse->fecha->format('d-m-Y') !!}"
