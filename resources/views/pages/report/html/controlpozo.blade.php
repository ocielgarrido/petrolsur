...
<body>
    ...
    <div class="center">   
        <p style="text-align: center; vertical-align: middle;font-size=20; font-family: arial, sans-serif; font-weight: bold;"> CONTROLES DE POZOS</p>
    </div>
    <div class="lef">   
        <p style="text-align: left; vertical-align: middle;font-size=12; font-family: arial, sans-serif; font-weight: bold;">Pozo: {{$pozo}}</p>
        <p style="text-align: left; vertical-align: middle;font-size=12; font-family: arial, sans-serif; font-weight: bold;">Desde: {{$desde}}</p>
        <p style="text-align: left; vertical-align: middle;font-size=12; font-family: arial, sans-serif; font-weight: bold;">Hasta: {{$hasta}}</p>
    </div>
    ...
    <div>
        <table style="width: 100%; border: 1px solid black;">
            <thead >
                <tr>
                    <th colspan="10" style="text-align: center; color:blue">CONTROLES DE POZO {{$area}}</th>
                </tr>    
                <tr>
                    ...
                    <th style="text-align: right;">GOR</th>
                </tr>
            </thead>
            <tbody>                                    
                ...
                <tr>
                    ...
                    <td style="text-align: right;">{{$dataWell->gor}}</td>
                <tr>   
                @empty    
                @endforelse
            </tbody> 
